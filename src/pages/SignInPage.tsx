...
export function SignInPage() {
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center p-6 relative overflow-hidden">
      ...
      />
      <div
        className="absolute -bottom-32 -right-20 w-[28rem] h-[28rem] rounded-full opacity-50 blur-3xl pointer-events-none"
        style={{ backgroundColor: '#D4B8F0' }}
      />
      <div
        className="absolute top-1/2 -right-40 w-80 h-80 rounded-full opacity-40 blur-3xl pointer-events-none"
        style={{ backgroundColor: '#F0B8D0' }}
      />

      {/* Tarjetas flotantes decorativas — sólo desktop */}
      <div className="hidden lg:block absolute top-16 left-16 rotate-[-8deg]">
      ...
      <div className="hidden lg:block absolute bottom-24 left-24 rotate-[6deg]">
        <div className="bg-white rounded-2xl shadow-card px-4 py-3 flex items-center gap-3 w-52">
      ...
      <div className="hidden lg:block absolute top-20 right-16 rotate-[5deg]">
        <div className="bg-white rounded-2xl shadow-card px-4 py-3 flex items-center gap-3 w-52">
      ...
      <div className="hidden lg:block absolute bottom-20 right-20 rotate-[-4deg]">
        <div className="bg-white rounded-2xl shadow-card px-4 py-3 flex items-center gap-3 w-48">
          <div className="w-7 h-7 rounded-lg bg-[#F2E840] flex items-center justify-center text-ink font-display text-xs flex-shrink-0">
            ★
          </div>
          <span className="font-body text-xs text-ink/70">Alta prioridad</span>
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 w-full max-w-sm">
        ...
        <div className="text-center">
          ...
          <p className="font-body text-sm text-ink/40">
            Organiza tu trabajo, un board a la vez.
          </p>
        </div>
